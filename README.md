...
5. **유지관리** — "내 원두 목록"에서 수정·삭제·URL 복사, **CSV 백업 다운로드 / 백업 복원**(내 유저코드 KEY만, 같은 KEY는 백업 내용으로 덮어쓰기 — 실수 삭제·악의적 변조를 백업 시점으로 되돌림).
